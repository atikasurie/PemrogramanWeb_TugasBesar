...
<html>
    ...
    <body>
        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    <h1>Es Kopi Kori Kohi</h1>
                    <p>
                        <img src="KORI-KOHI.JPG">
                    </p>
                    <center>
                    <font size="4">
                    <p>12.000</p>
                    <p>
                    Kori Kohi, menu kopi yang merupakan signature atau menu khas Asagao Coffee House. Nggak seperti kopi pada umumnya yang disajikan setelah di-blend, Kuniko justru disajikan dalam bentuk bahan-bahan mentahnya yaitu susu yang foamy dan kopi espresso dalam bentuk es batu yang terpisah. Jadi, seberapa pekatnya kopi kita ini tergantung preferensi kita lho karena kita yang menentukan sendiri berapa banyak susu yang ditambahkan ke es batu espresso.
                    </p>
                    </font>
                </center>
                <div class="kiri">
