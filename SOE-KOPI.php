...
<html>
    ...
    <body>
        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    <h1>Es Kopi soe Gula Merah</h1>
                    <p>
                        <img src="SOE-KOPI.JPG">
                    </p>
                    <center>
                    <font size="4">
                    <p>10.000</p>
                    <p>
                    Kopisoe Goela Merah dari Kopi Soe mengkombinasikan rasa kopi yang agak pahit dengan gula merah yang manisnya pas. Tapi, Kopisoe Goela Merah dari Kopi Soe bukan cuma kopi dan gula merah biasa lho karena salah satu menu kopi terenak di Jakarta yang satu ini juga ditambahkan sirup rhum yang bikin kopinya memiliki wangi khas rhum. Tekstur dari menu kopi yang satu ini lumayan creamy, tapi nggak pekat sehingga cocok untuk kamu yang suka kopi tapi nggak mau kopi yang terlalu strong.
                    </p>
                    </font>
                </center>
                <div class="kiri">
