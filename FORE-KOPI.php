...
<html>
    ...
    <body>
        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    <h1>Es Fore Coffee</h1>
                    <p>
                        <img src="FORE-KOPI.JPG">
                    </p>
                    <center>
                    <font size="4">
                    <p>12.000</p>
                    <p>
                    Fore Coffee, nggak seperti kopi susu pada umumnya, Fore Pandan Latte mengkombinasikan rasa kopi pahit yang strong, susu yang creamy, dengan ekstrak daun pandan yang manis dan wangi. Walaupun kombinasi rasanya unik, ekstrak pandan dan kopi dalam Fore Pandan Latte ini nggak saling bersaing lho, tapi justru melengkapi rasa satu sama lain dan bikin menu kopi ini enak. Selain itu, tekstur campuran kopi, susu, dan pandan juga bikin Fore Pandan Latte punya rasa yang mirip es cendol lho.
                    </p>
                    </font>
                </center>
                <div class="kiri">
