...
<html>
    ...
    <body>
        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    <h1>SAPI LADA HITAM</h1>
                    <p>
                        <img src="SAPILADAHITAM.lnk">
                    </p>
                    <center>
                    <font size="4">
                    <p> Rp 15.000 </p>
                    <p>
                       Daging sapi memang merupakan salah satu bahan baku yang paling fleksibel dan dapat dimasak dalam bentuk apa saja. Salah satu yang paling favorit adalah daging sapi lada hitam yang sangat khas. Yang menguntungkan dari daging sapi lada hitam adalah ukurannya yang tidak terlalu besar sehingga mudah untuk dinikmati secara tidak berlebihan.
                    </p>
                    </font>
                </center>
                <div class="kiri">
                <a href="PEDAS.php"><input type="submit" value="KEMBALI" class="buttom1"></a>
