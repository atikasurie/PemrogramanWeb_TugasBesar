        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    ...
                    <div class="FOTO">
                        <a href="ALPUKAT.php"><img src="JUS ALPUKAT.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Jus Alpukat</td>
                            ...
                            <tr>
                                <td><button><a href="ALPUKAT.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="MANGGA.php"><img src="JUS MANGGA.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Jus Mangga</td>
                            ...
                            <tr>
                                <td><button><a href="MANGGA.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="APEL.php"><img src="APEL.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Jus Apel</td>
                            ...
                            <tr>
                                <td><button><a href="APEL.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="BUAHNAGA.php"><img src="BUAH-NAGA.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Jus Buah Naga</td>
                            ...
                            <tr>
                                <td><button><a href="BUAHNAGA.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="JERUK.php"><img src="JERUK.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Jus Jeruk</td>
                            ...
                            <tr>
                                <td><button><a href="JERUK.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="NANAS.php"><img src="NANAS.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Jus Nanas</td>
                            ...
                            <tr>
                                <td><button><a href="NANAS.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="WORTEL.php"><img src="WORTEL.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Jus Wortel</td>
                            ...
                            <tr>
                                <td><button><a href="WORTEL.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="JAMBU.php"><img src="JAMBU.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Jus Jambu Merah</td>
                            </tr>
                            <tr>
                                <td>Rp 7.000</td>
                            </tr>
                            <tr>
                                <td><button><a href="JAMBU.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
