        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    <h1>Jus Mangga</h1>
                    <p>
                        <img src="JUS MANGGA.JPG">
                    </p>
                    <center>
                    <font size="4">
                    <p>7.000</p>
                    <p>
                    Jus mangga dibuat dari buah yang telah matang berwarna oranye. Buah mangga yang masih mentah belum bisa dijadikan jus, karena teksturnya keras dan rasanya cukup asam. Selain rasanya lezat dan segar, jus mangga kaya manfaat bagi kesehatan tubuh. Terlebih, jus mangga dipercaya dapat membantu mengatasi penyakit tertentu.
                    </p>
                    </font>
                </center>
                <div class="kiri">
                <a href="JUS.php"><input type="submit" value="KEMBALI" class="buttom1"></a>
