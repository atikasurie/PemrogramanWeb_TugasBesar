        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    <h1>Jus Alpukat</h1>
                    <p>
                        <img src="JUS ALPUKAT.JPG">
                    </p>
                    <center>
                    <font size="4">
                    <p> Rp 10.000 </p>
                    <p>
                    Jus buah alpukat disebut mengandung lemak tak jenuh sehingga aman untuk dikonsumsi secara rutin. Tak hanya lemak baik, minuman yang satu ini juga kaya nutrisi, seperti vitamin A,B,C,E, dan K serta karbohidrat, protein, folat, hingga magnesium.
                    </p>
                    </font>
                </center>
                <div class="kiri">
