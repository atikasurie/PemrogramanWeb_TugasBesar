        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    <h1>GOLDEN OS</h1>
                    <p>
                        <img src="GOLDEN OS.jpg">
                    </p>
                    <center>
                    <font size="4">
                    <p>35.000</p>
                    <p>
                    GOLDEN OS ini adalah dessert dengan es cream mewah, ini sangat cocok bagi yang penikmat es cream yang mewah, menu ini bagus dinikmati dalam cuaca panas dan bersantai.
                    </p>
                    </font>
                </center>
                <div class="kiri">
