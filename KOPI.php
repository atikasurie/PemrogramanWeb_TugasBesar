        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    ...
                    <div class="FOTO">
                        <a href="POKAT.php"><img src="POKAT.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Es Kopi Pokat</td>
                            ...
                            <tr>
                                <td><button><a href="POKAT.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="CINCAU.php"><img src="CINCAU.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                    ...
                    <div class="FOTO">
                        <a href="ICE.php"><img src="ICE.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                    ...
                    <div class="FOTO">
                        <a href="KORI-KOHI.php"><img src="KORI-KOHI.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Es Kopi Kori Kohi</td>
                            </tr>
                            <tr>
                                <td>Rp 12.000</td>
                            </tr>
                            <tr>
                                <td><button><a href="KORI-KOHI.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="FORE-KOPI.php"><img src="FORE-KOPI.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Es Fore Coffee</td>
                            </tr>
                            <tr>
                                <td>Rp 12.000</td>
                            </tr>
                            <tr>
                                <td><button><a href="FORE-KOPI.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="CARAMEL.php"><img src="CARAMEL.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Es Kopi Caramel Cookie</td>
                            </tr>
                            <tr>
                                <td>Rp 15.000</td>
                            </tr>
                    ...
                    <div class="FOTO">
                        <a href="OMBE-KOPI.php"><img src="OMBE-KOPI.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Es Ombe Kofie</td>
                            ...
                            <tr>
                                <td><button><a href="OMBE-KOPI.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="SOE-KOPI.php"><img src="SOE-KOPI.JPG" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>Es Kopi soe Gula Merah</td>
                            </tr>
                            <tr>
                                <td>Rp 10.000</td>
                            </tr>
                            <tr>
                                <td><button><a href="SOE-KOPI.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
