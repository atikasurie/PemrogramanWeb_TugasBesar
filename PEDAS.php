        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    ...
                    <div class="FOTO">
                        <a href="BAKSO.php"><img src="BAKSO.jpeg" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>BAKSO</td>
                            ...
                            <tr>
                                <td><button><a href="BAKSO.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="AYAMRICA.php"><img src="AYAMRICA.jpg" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                    ...
                    <div class="FOTO">
                        <a href="SAPILADAHITAM.php"><img src="sapi.jpeg" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>SAPI LADA HITAM</td>
                            </tr>
                            <tr>
                                <td>Rp 15.000</td>
                            </tr>
                            <tr>
                                <td><button><a href="SAPILADAHITAM.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="CEKERMERCON.php"><img src="CEKERMERCON.jpg" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>CEKER MERCON</td>
                    ...
                    <div class="FOTO">
                        <a href="AYAMGEPREK.php"><img src="AYAMGEPREK.jpg" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>AYAM GEPREK</td>
                            ...
                            <tr>
                                <td><button><a href="AYAMGEPREK.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="AYAMBETUTU.php"><img src="AYAMBETUTU.webp" class="poto"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>AYAM BETUTU</td>
                            ...
                            <tr>
                                <td><button><a href="AYAMBETUTU.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="NASIGORENGPED.php"><img src="NASGORPED.jpeg"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>NASI GORENG</td>
                            ...
                            <tr>
                                <td><button><a href="NASIGORENGPED.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class="FOTO">
                        <a href="OSENGTEMPEPEDAS.php"><img src="OSENGTEMPEPED.jpeg"></a>
                        <div class="BAWAH">
                        <table border="0">
                            <tr>
                                <td>OSENG TEMPE PEDAS</td>
                            </tr>
                            <tr>
                                <td>Rp 10.000</td>
                            </tr>
                            <tr>
                                <td><button><a href="OSENGTEMPEPEDAS.php">Lihat Deskripsi</a></button></td>
                            </tr>
                        </table>
                        </div>
                    </div>
