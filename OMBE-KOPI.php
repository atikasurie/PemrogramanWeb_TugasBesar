        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    <h1>Es Ombe Kofie</h1>
                    <p>
                        <img src="OMBE-KOPI.JPG">
                    </p>
                    <center>
                    <font size="4">
                    <p>10.000</p>
                    <p>
                    Minum lemon tea mungkin udah biasa buat kamu. Saatnya cobain lemon coffee! Di Ombe Kofie, kamu bisa cobain menu Thunderbolt yang merupakan kombinasi kopi hitam cold brew dengan sirup lemon yang asam. Untuk kamu yang suka kopi pekat yang asam, menu satu ini cocok banget buat kamu. Selain rasanya yang asam-asam segar, ketika disajikan harumnya khas kopi banget, ketika diaduk justru Thunderbolt akan punya keharuman yang mirip lemon tea lho. Untuk kamu yang maniak kopi dan ingin cobain rasa baru, Thunderbolt dari Ombe Kofie cocok banget buat kamu.
                    </p>
                    </font>
                </center>
                <div class="kiri">
                <a href="KOPI.php"><input type="submit" value="KEMBALI" class="buttom1"></a>
