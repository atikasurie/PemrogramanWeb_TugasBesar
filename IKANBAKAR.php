        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    <h1>IKAN BAKAR</h1>
                    <p>
                        <img src="IKANBAKAR.jpeg">
                    </p>
                    <center>
                    <font size="4">
                    <p> Rp 15.000 </p>
                    <p>
                       Ikan bakar adalah hidangan ikan yang dibakar atau dipanggang di atas api atau bara api. Hidangan ikan yang dibakar muncul secara universal di berbagai belahan dunia. Akan tetapi secara khusus istilah ikan bakar merujuk kepada ikan bakar khas Malaysia dan Indonesia. Ikan bakar adalah salah satu hidangan klasik Indonesia.
                    </p>
                    </font>
                </center>
                <div class="kiri">
                <a href="MANIS.php"><input type="submit" value="KEMBALI" class="buttom1"></a>
