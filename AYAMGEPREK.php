        ...
        <section id="contens">
            <div class="container">
                <div class="kiri">
                    <h1>AYAM GEPREK</h1>
                    <p>
                        <img src="AYAMGEPREK.jpg">
                    </p>
                    <center>
                    <font size="4">
                    <p> Rp 12.000 </p>
                    <p>
                       Ayam geprek adalah makanan ayam goreng tepung khas Indonesia yang diulek atau dilumatkan bersama sambal. Ayam geprek menjadi hidangan populer yang dapat ditemukan di hampir semua kota besar di Indonesia. Asal mula ayam geprek berasal dari kota Yogyakarta.
                    </p>
                    </font>
                </center>
                <div class="kiri">
